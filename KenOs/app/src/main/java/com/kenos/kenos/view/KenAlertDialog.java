...
import com.kenos.kenos.task.DownloadImageTask;
import com.kenos.kenos.utils.ImageCache;

import java.io.File;

public class KenAlertDialog extends BaseActivity {
	...
	public void ok(View view){
		setResult(RESULT_OK,new Intent().putExtra("position", position).putExtra("edittext", editText.getText().toString())/*.putExtra("voicePath", voicePath)*/);
