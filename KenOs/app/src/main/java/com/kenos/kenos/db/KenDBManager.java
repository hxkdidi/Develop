...
public class KenDBManager {
    static private KenDBManager dbMgr = new KenDBManager();
    private DbOpenHelper dbHelper;

    private KenDBManager() {
        dbHelper = DbOpenHelper.getInstance(KenApplication.getInstance().getApplicationContext());
    }

    public static synchronized KenDBManager getInstance() {
        if (dbMgr == null) {
            dbMgr = new KenDBManager();
        }
        return dbMgr;
    }
